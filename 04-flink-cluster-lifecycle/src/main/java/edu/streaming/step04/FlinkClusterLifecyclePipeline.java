...
public final class FlinkClusterLifecyclePipeline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<String, Long, Double>> readings = env
                ...
                .name("event-counter")
                .setParallelism(1)
                .map(FlinkClusterLifecyclePipeline::sampleEvent)
        ...
        DataStream<Tuple5<String, Long, Long, Long, Double>> averages = readings
    ...
    public static final class LifecycleFormatter
            extends RichMapFunction<Tuple5<String, Long, Long, Long, Double>, String> {
        ...
        @Override
        public String map(Tuple5<String, Long, Long, Long, Double> average) {
            if (formatter == null) {
    ...
    public static final class BadConstructorFormatter
            extends RichMapFunction<Tuple5<String, Long, Long, Long, Double>, String> {
    ...
    private static final class LocalFormatter {
        ...
        private String format(Tuple5<String, Long, Long, Long, Double> average) {
            return String.format(
                    Locale.US,
                    "%s subtask=%d/%d thread=%s room=%s window=[%s,%s) count=%d average=%.1f C",
                    label,
                    subtaskIndex + 1,
                    parallelism,
                    threadName,
